...
const Form = ({input,setInput, addData}) => {
  return (
...
<div class=" flex items-center mb-4">
  ...
  <button class="ml-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out transform hover:scale-105" type='submit' onClick={(e)=>addData(e)}>
      Add
    </button>
</div>
</form>
